...
И ещё одну - такой же размерности. Числа в матрице выше привидены
в качестве примера (одна из генераций)
...
Задание считается выполненным, если вы напишите алгоритм, который
будет уметь как складывать матрицы, так и генерировать
матрица различных размерностей. Будь то матрицы 10х10 или 4х3
...
#     matrix_2.append([randint(-222, 10) for i in range(0, width)])
#     matrix_1.append([randint(-222, 11) for i in range(0, width)])
#
# pprint.pprint(matrix_2, width=sum([len(str(i)) for i in matrix_2]))
# print()
# pprint.pprint(matrix_1, width=sum([len(str(i)) for i in matrix_1]))
# print()
# for i in range(length):
#     for j in range(width):
#         lst.append(matrix_2[i][j] + matrix_1[i][j])
#     matrix_3.append(lst)
#     lst = []
# pprint.pprint(matrix_3, width=sum([len(str(i)) for i in matrix_3]))
